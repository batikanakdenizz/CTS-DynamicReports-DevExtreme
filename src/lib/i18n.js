...
const messages = {
  tr: {
    ...
    'line.singleNote': 'Çizgi grafiği tek nokta gösteriyor — trend için Date kırılımını ekle',
    ...
    'btn.excel': 'Excel',
    'btn.pdf': 'PDF',
    'export.failed': 'Dışa aktarma başarısız — ayrıntı için konsola bakın',
    'topbar.lang': 'Dil',
  ...
  en: {
    ...
    'line.singleNote': 'Line chart has a single point — add the Date dimension to see a trend',
    ...
    'btn.excel': 'Excel',
    'btn.pdf': 'PDF',
    'export.failed': 'Export failed — see console for details',
