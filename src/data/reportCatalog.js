...
// Gruplu seçenek listesi (measure seçici için)
...
export const CHART_TYPES = [
  { label: 'Bar', value: 'bar', icon: 'dx-icon-databaroutline' },
  { label: 'Stacked', value: 'stacked', icon: 'dx-icon-datastackedbaroutline' },
  { label: 'Line', value: 'line', icon: 'dx-icon-datalineoutline' },
  { label: 'Donut', value: 'donut', icon: 'dx-icon-datadoughnutoutline' },
]
